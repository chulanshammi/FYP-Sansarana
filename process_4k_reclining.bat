@echo off
REM ============================================
REM  Run COLMAP on 4K frames — Reclining Statue
REM ============================================
...
echo.
echo ============================================
echo  Processing Reclining Statue 4K frames
echo  Running COLMAP (this may take a while)
echo ============================================
echo.

ns-process-data images --data D:\Sansarana\outputs\reclining_4k\images --output-dir D:\Sansarana\outputs\reclining_4k --matching-method vocab_tree
pause
