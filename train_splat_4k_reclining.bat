...
REM  Reclining Buddha — 4K Dataset
REM ============================================
...
ns-train splatfacto --max-num-iterations 60000 --steps-per-save 5000 colmap --data D:\Sansarana\outputs\reclining_4k --downscale-factor 2
pause
