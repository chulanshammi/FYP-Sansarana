@echo off
REM ============================================
REM  Run COLMAP on 4K frames via ns-process-data
REM ============================================
...
echo.
echo ============================================
echo  Processing 358 frames at 3840x2160
echo  Running COLMAP (this may take a while)
echo ============================================
echo.

ns-process-data images --data D:\Sansarana\outputs\seated_4k\images --output-dir D:\Sansarana\outputs\seated_4k --matching-method vocab_tree
pause
