@echo off
REM ============================================
REM  Run COLMAP on 4K frames — Standing Statue
REM ============================================
...
echo.
echo ============================================
echo  Processing Standing Statue 4K frames
echo  Running COLMAP (this may take a while)
echo ============================================
echo.

ns-process-data images --data D:\Sansarana\outputs\standing_4k\images --output-dir D:\Sansarana\outputs\standing_4k --matching-method vocab_tree
pause
